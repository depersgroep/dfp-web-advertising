...
window.dfp = (function(tar, w, d, c) {
	...
	/* start-test-block */
	tar.__testonly__ = {};
	tar.__testonly__.setGlobalTargeting = _setGlobalTargeting;
	tar.__testonly__.setTargeting = _setTargeting;
	tar.__testonly__.getSafeTargetValue = _getSafeTargetValue;
	tar.__testonly__.defineSlots = _defineSlots;
	tar.__testonly__.defineSlot = _defineSlot;
	tar.__testonly__.setEventListeners = _setEventListeners;
	tar.__testonly__.slotRenderEnded = _slotRenderEnded;
	tar.__testonly__.displayDebug = _displayDebug;
